        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="dropdown mx-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class='dropdown-item' href='/beauty_store/forms/clientStats.php'>Clients</a></li>
                    <li><a class='dropdown-item' href='/beauty_store/forms/fournisseur.php'>Fournisseurs</a></li>
                    <li><a class='dropdown-item' href='/beauty_store/forms/facture.php'>Factures</a></li>
                </ul>
            </div>

            <div class="offset-md-3 d-flex">

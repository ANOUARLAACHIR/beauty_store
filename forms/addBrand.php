...
?>
    ...
    <div class="row my-1">
        ...
        <div class="col-md-9 my-4">
            ...
            <form method="post" action="../processing/addBrandProcess.php" enctype="multipart/form-data">
                <div class="form-group row my-3">
                    <div class="col-md-3">
                        <label for="name">Nom Marque: </label>
                    </div>
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nom de Categorie" required>
                    </div>
                </div>
                <div class="form-group row my-3">
                    <div class="col-md-3">
